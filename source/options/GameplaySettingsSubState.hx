...
class GameplaySettingsSubState extends BaseOptionsMenu
{
        public function new()
        {
                ...
                // =============================
                // NOVAS OPÇÕES STRUMLINE BG
                // =============================

                var option:Option = new Option('Strumline Backgrounds',
                        'Adds a black bar behind the strumline notes.',
                        'strumlineBG',
                        'bool');
                addOption(option);

                var option:Option = new Option('Strumline BG Opacity',
                        'Controls the opacity of the strumline background.',
                        'strumlineBGAlpha',
                        'percent');
                addOption(option);
